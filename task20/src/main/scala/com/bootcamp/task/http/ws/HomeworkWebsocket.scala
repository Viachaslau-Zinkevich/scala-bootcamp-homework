package com.bootcamp.task.http.ws

import cats.effect._
import cats.implicits._
import cats.kernel.Comparison.{EqualTo, GreaterThan, LessThan}
import com.bootcamp.task.http.ws.GuessResult._
import fs2.concurrent.Queue
import fs2.{Chunk, Pipe, Pull, Stream}
import org.http4s._
import org.http4s.client.jdkhttpclient.{JdkWSClient, WSConnectionHighLevel, WSDataFrame, WSFrame, WSRequest}
